...
namespace DDDTemplate.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddInfrastructure(Configuration.GetConnectionString("DefaultConnectionString"));

            services.AddService(connectionStringOptions =>
            {
                connectionStringOptions.ConnectionString = Configuration.GetConnectionString("DefaultConnectionString");
            });
        }
